CREATE TABLE IF NOT EXISTS _content_type_operations
(
	pk_content_type_operation_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	fk_content_type_id int (11) unsigned NOT NULL,
	fk_operation_id int(11) unsigned NOT NULL,
	name varchar(100) DEFAULT NULL,
	PRIMARY KEY (pk_content_type_operation_id),
